(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["SlateAutomergeBridge"] = factory();
	else
		root["SlateAutomergeBridge"] = factory();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_automerge__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_automerge___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_automerge__);
/**
...
/* harmony default export */ __webpack_exports__["a"] = (toJSON);
...
/* harmony default export */ __webpack_exports__["a"] = (fromJSON);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__applySlateOperations__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__applyAutomergeOperations__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__slateCustomToJson__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__automergeJsonToSlate__ = __webpack_require__(2);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "applySlateOperations", function() { return __WEBPACK_IMPORTED_MODULE_0__applySlateOperations__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "applyAutomergeOperations", function() { return __WEBPACK_IMPORTED_MODULE_1__applyAutomergeOperations__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "automergeJsonToSlate", function() { return __WEBPACK_IMPORTED_MODULE_3__automergeJsonToSlate__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "slateCustomToJson", function() { return __WEBPACK_IMPORTED_MODULE_2__slateCustomToJson__["a"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_automerge__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_automerge___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_automerge__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__slateCustomToJson__ = __webpack_require__(1);
/**
 ...
 */
const applySlateOperations = (docSet, docId, slateOperations, clientId) => {
    const currentDoc = docSet.getDoc(docId);
    if (currentDoc) {
        const message = clientId ? `Client ${clientId}` : "Change log";
        const docNew = __WEBPACK_IMPORTED_MODULE_0_automerge___default.a.change(currentDoc, message, doc => {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = applySlateOperations;
    ...
    operations.forEach(op => {
        ...
        switch (op.type) {
            ...
            case "split_node":
                ...
                if (properties) {
                    if (currentNode.nodes[index + 1].object !== "text") {
                        let propertiesJSON = Object(__WEBPACK_IMPORTED_MODULE_1__slateCustomToJson__["a" /* default */])(properties);
            ...
            case "insert_node":
                ...
                currentNode.nodes.insertAt(index, Object(__WEBPACK_IMPORTED_MODULE_1__slateCustomToJson__["a" /* default */])(node));
                break;
            case "remove_node":
                rest.forEach(el => {
                    currentNode = currentNode.nodes[el];
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__automergeJsonToSlate__ = __webpack_require__(2);
/**
 ...
 */
const applyAutomergeOperations = (opSetDiff, change, failureCallback) => {
    try {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = applyAutomergeOperations;
 ...
 */
const convertAutomergeToSlateOps = automergeOps => {
...
/* unused harmony export convertAutomergeToSlateOps */
    ...
    deferredOps.forEach((op, idx) => {
        ...
        switch (nodeToAdd.object) {
            case "text":
                ...
                break;
            case "block":
                const newNode = Object(__WEBPACK_IMPORTED_MODULE_0__automergeJsonToSlate__["a" /* default */])(nodeToAdd);
...
//# sourceMappingURL=slateAutomergeBridge.js.map
